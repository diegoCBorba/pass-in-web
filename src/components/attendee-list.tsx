                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b border-white/10 text-left">
                            ...
                            <th className='py-3 px-4 text-sm font-semibold'>Data da inscrição</th>
                        ...
                        {Array.from({ length: 8 }).map((_, i) => {
                            return(
                                <tr key={i} className='border-b border-white/10 hover:bg-white/5'>
                                    ...
                                    <td className='py-3 px-4 text-sm text-zinc-300'>98798</td>
                                    <td className='py-3 px-4 text-sm text-zinc-300'>
                                        <div className='flex flex-col gap-1'>
                                            <span className='font-semibold text-white'>Diego Cardoso dos Santos</span>
                                            <span>diegocardosobsantos@gmail.com</span>
                                        </div>
                                    </td>
